...
void ZipArchive_fill_fopen_filefunc OF((zlib_filefunc_def* pzlib_filefunc_def));
void ZipArchive_fill_fopen64_filefunc OF((zlib_filefunc64_def* pzlib_filefunc_def));
